...
public:
    ...
    virtual bool OpenAudioChannel(bool silent = false) = 0;
    virtual void CloseAudioChannel(bool send_goodbye = true) = 0;
    virtual bool IsAudioChannelOpened() const = 0;
    virtual bool IsStale(int max_idle_s) const { return false; }
    ...
    // Phase 7.1: 打断后置位, 协议层丢弃后续下行音频包, 防止"停完又播"
    virtual void SetAudioAborted(bool aborted) { audio_aborted_ = aborted; }
...
protected:
    ...
    std::atomic<bool> audio_aborted_{false};
